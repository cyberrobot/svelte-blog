...
{:else if depth === 4}
	<h4 class="mb-8 font-heading text-sm font-medium text-black"><slot /></h4>
{:else if depth === 5}
	<h5 class="mb-8 font-heading text-xs font-medium text-black"><slot /></h5>
{:else if depth === 6}
	<h6 class="mb-8 font-heading text-xs font-medium text-black"><slot /></h6>
{:else}
	{raw}
{/if}
